...
public class MauriceDialogue : CharacterDialogue
{
    ...
    private MauriceDialogue()
    {
        storyLines[GameManager.GameState.TUTORIAL_1] = new string[]
        {
            "Hey, what's up",
            "Player",
            "Bertha looks as beautiful tonight as she did 30 years ago. How silly was I to think that a rich old man like me could have appealed to a beautiful young woman like her.",
            characterName
        };
        ...
        storyLines[GameManager.GameState.FIND_BERTHA] = new string[]
        {
            ...
            "Player", "Sorry, I can’t talk right now.", characterName
        };

        storyLines[GameManager.GameState.POWER_SOURCE] = new string[]
        {
            "Ha! I can’t believe Sam is claiming he’s going to be able to pay off all his debts after tonight - he never wins, tonight will be no different.",
            characterName, "What’s that big thing you’re carrying around?", "Player",
            ...
            characterName, "What? Show me the photos.", "Player", "Of course! Doesn’t Bertha look beautiful in these?",
            characterName, "Can I take that battery pack?", "Player", "Absolutely! I don't need it any more.",
        ...
        randomLines.Add(
            "Don’t know what’s been going on between Avni and Charles… she’s been glaring at him all night.");
