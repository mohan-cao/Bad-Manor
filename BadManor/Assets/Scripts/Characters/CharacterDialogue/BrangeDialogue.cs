...
public class BrangeDialogue : CharacterDialogue
{
    ...
    {
        storyLines[GameManager.GameState.TUTORIAL_1] = new string[] { "Hey, what's up", "Player", "Bertha looks as " +
        ...
        storyLines[GameManager.GameState.TUTORIAL_2] = new string[] { "Hey, what's up", "Player", "The debt " +
            "collectors will surely be paying a visit to Sam soon. He’s been bleeding money for months at the " +
            "blackjack table.", characterName };
        
        storyLines[GameManager.GameState.TUTORIAL_3] = new string[] { "Hey, what's up", "Player", "Why would Bertha " +
            "leave Charles off of the will? Maybe Avni’s complaints have gotten to her.", characterName };
        ...
        storyLines[GameManager.GameState.GET_SECURITY_KEY] = new string[] { "Do you know how I can get into the " +
            "security room?", "Player", "You’ll need a key to get in. Bertha manages everything around here, so I " +
            "don’t know exactly where it is, but she likes to hide things under the bathmats. Other than that, Mi Na " +
            "probably has a key.", characterName };

        /*
         * NEED TO ADD A WAY OF GETTING WHO THE PLAYER IS ACCUSING IN THIS INSTANCE
         */
        storyLines[GameManager.GameState.ACCUSE] = new string[] {  "Please find Bertha.", characterName, "I know " +
            "what happened to Bertha", "Player", "What do you mean? Something happened? Is everything alright?",
