...
public class MiNaDialogue : CharacterDialogue
{
    ...
    private MiNaDialogue()
    {
        ...
        storyLines[GameManager.GameState.FIND_BERTHA] = new string[] { "Have you seen Bertha lately?",
                    "Player", "Of course not, I just asked you to find her. Hurry up and do your job."
                    , characterName };
        ...
        storyLines[GameManager.GameState.INVESTIGATE_EVIDENCE] = new string[] { "I found a belt with the initials C.F.D. on it in the security room. Do you know anything about this?",
                    ...
                    , characterName
                    , "I need the security tapes. Where are they?", "Player"
                    ,"Th-they're in Charles' room.", characterName
                    ,"What? Why?", "Player"
                    ...
                    , "Ch-Charles and I are having an affair. I locked the tapes inside his room because it contains all the evidence. I’ll give you the keys to Charles’ room, just leave me alone.", characterName};
    ...
    public string[] getStoryLines(GameManager.GameState state)
    {
        ...
        {
            return new string[] { "I Thought I told you to leave me alone.",
