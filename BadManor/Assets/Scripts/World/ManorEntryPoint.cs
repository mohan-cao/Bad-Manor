...
namespace Assets.Scripts.World
{
    ...
    public class ManorEntryPoint : MonoBehaviour
    {
        ...
        {
            GroundToToilet1, GroundToToilet2,
            GroundToFirstFloor, GroundToBasement,
            
            BasementToCellar, CellarToSecurityRoom,

            FirstToRoom, FirstToRoof,

            RoofToChimney, ChimneyToRoof,

            Chimney0To1, Chimney1To2
        }
